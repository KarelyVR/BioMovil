...
class UbicacionCoyote extends StatefulWidget {
  const UbicacionCoyote({super.key});

  @override
  State<UbicacionCoyote> createState() => _UbicacionCoyoteState();
}

class _UbicacionCoyoteState extends State<UbicacionCoyote> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      focusOnPoint(const LatLng(25.71886018518749, -100.31468389834086));
    });
  }
  ...
  Future<void> getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      google_api_key,
      const PointLatLng(25.71886018518749, -100.31468389834086),
        ...
        children: [
          ...
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/animales/desierto/coyote.jpg'),
            ),
          ),
        ],
      ),

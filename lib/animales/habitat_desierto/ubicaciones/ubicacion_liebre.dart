...
class UbicacionLiebre extends StatefulWidget {
  const UbicacionLiebre({super.key});

  @override
  State<UbicacionLiebre> createState() => _UbicacionLiebreState();
}

class _UbicacionLiebreState extends State<UbicacionLiebre> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      focusOnPoint(const LatLng(25.71765852555807, -100.31222692388545));
    });
  }
  ...
  Future<void> getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      google_api_key,
      const PointLatLng(25.71765852555807, -100.31222692388545),
        ...
        children: [
          ...
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/animales/desierto/liebre.jpeg'),
            ),
          ),
        ],
      ),

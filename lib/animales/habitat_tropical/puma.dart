                    ...
                    child: ElevatedButton(
                      child: const Text('¡Escucha su sonido!'),
                        ...
                        Padding(
                          ...
                          child: Text(
                            'Nombre cientifico: Puma concolor\nFamilia: Felidae\nClase: Mammalia\nPromedio de vida: 8 a 13 años\nAltura: 60 a 76 cm\nPeso: 29 a 80 kg\nColores: El pelaje es generalmente de color uniforme y puede variar en tonalidades de marrón, desde un marrón claro hasta un marrón oscuro.',
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => const UbicacionPuma(),
                              ));
                            },

...
class UbicacionTigre extends StatefulWidget {
  const UbicacionTigre({super.key});

  @override
  State<UbicacionTigre> createState() => _UbicacionTigreState();
}

class _UbicacionTigreState extends State<UbicacionTigre> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      focusOnPoint(const LatLng(25.726906886537034, -100.31486868597997));
    });
  }
  ...
  Future<void> getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      google_api_key,
      const PointLatLng(25.726906886537034, -100.31486868597997),
        ...
        children: [
          ...
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/animales/tropical/tigre.jpg'),
            ),
          ),
        ],
      ),

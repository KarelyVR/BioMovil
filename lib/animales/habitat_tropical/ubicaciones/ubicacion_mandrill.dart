...
class UbicacionMandrill extends StatefulWidget {
  const UbicacionMandrill({super.key});

  @override
  State<UbicacionMandrill> createState() => _UbicacionMandrillState();
}

class _UbicacionMandrillState extends State<UbicacionMandrill> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      focusOnPoint(const LatLng(25.72670021620236, -100.3158501262181));
    });
  }
  ...
  Future<void> getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      google_api_key,
      const PointLatLng(25.72670021620236, -100.3158501262181),
        ...
        leading: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const Mandrill(),
              ),
            );
          },
          child: Container(
        ...
        children: [
          ...
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/animales/tropical/mandrill.jpg'),
            ),
          ),
        ],
      ),

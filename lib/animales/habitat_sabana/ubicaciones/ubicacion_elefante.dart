...
class UbicacionElefante extends StatefulWidget {
  const UbicacionElefante({super.key});

  @override
  State<UbicacionElefante> createState() => _UbicacionElefanteState();
}

class _UbicacionElefanteState extends State<UbicacionElefante> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      focusOnPoint(const LatLng(25.730165206212476, -100.30855117545211));
    });
  }
  ...
  Future<void> getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      google_api_key,
      const PointLatLng(25.730165206212476, -100.30855117545211),
        ...
        leading: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const Elefante(),
              ),
            );
          },
          child: Container(
        ...
        children: [
          ...
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/animales/sabana/elefante.jpg'),
            ),
          ),
        ],
      ),

...
class UbicacionAvestruz extends StatefulWidget {
  const UbicacionAvestruz({super.key});

  @override
  State<UbicacionAvestruz> createState() => _UbicacionAvestruzState();
}

class _UbicacionAvestruzState extends State<UbicacionAvestruz> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      focusOnPoint(const LatLng(25.728557779673796, -100.30768312058856));
    });
  }
  ...
  Future<void> getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      google_api_key,
      const PointLatLng(25.728557779673796, -100.30768312058856),
        ...
        leading: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => const Avestruz(),
              ),
            );
          },
          child: Container(
        ...
        children: [
          ...
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/animales/sabana/avestruz.jpg'),
            ),
          ),
        ],
      ),

...
class UbicacionLeon extends StatefulWidget {
  const UbicacionLeon({super.key});

  @override
  State<UbicacionLeon> createState() => _UbicacionLeonState();
}

class _UbicacionLeonState extends State<UbicacionLeon> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    setState(() {
      ...
      focusOnPoint(const LatLng(25.729349114116648, -100.31149812513222));
    });
  }
  ...
  Future<void> getPolyPoints() async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      google_api_key,
      const PointLatLng(25.729349114116648, -100.31149812513222),
        ...
        children: [
          ...
          Container(
            ...
            child: const CircleAvatar(
              ...
              backgroundImage: AssetImage('assets/animales/sabana/leon.jpg'),
            ),
          ),
        ],
      ),
